...
describe('Extrinsic', (): void => {
  describe('V4', (): void => {
    it('decodes an actual transaction', (): void => {
      ...
      expect(extrinsic.era.toHuman()).toEqual({ type: 'MortalEra', value: { period: '1,024', phase: '186' } });
      expect(extrinsic.nonce.toNumber()).toEqual(68);
      expect(extrinsic.tip.toHuman()).toEqual('30000000000');
      ...
      expect(extrinsic.args[1].toHuman()).toEqual('104560923320000'); // ('104.5609 Unit');
